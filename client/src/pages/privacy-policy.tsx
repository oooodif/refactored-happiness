...
export default function PrivacyPolicy() {
  ...
  return (
    <SiteLayout seoTitle="Privacy Policy - AI LaTeX Generator" hideFooter={false}>
      ...
      <div className="min-h-screen bg-gray-50/80 dark:bg-gray-900/80 py-8">
        ...
        >
          <motion.div 
            className="text-center px-4 py-10 max-w-4xl mx-auto z-10"
          ...
          >
            <motion.h1 
              ...
              className="text-4xl sm:text-5xl font-extrabold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-cyan-500"
            >
              Privacy Policy
            </motion.h1>
            <motion.p 
