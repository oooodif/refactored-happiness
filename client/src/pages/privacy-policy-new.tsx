...
export default function PrivacyPolicy() {
  ...
  return (
    <SiteLayout seoTitle="Privacy Policy - AI LaTeX Generator" hideFooter={false}>
      {/* Full page gradient animation background */}
      <div className="fixed inset-0 gradient-animation opacity-20 -z-10" />
      <div className="fixed inset-0 bg-grid-pattern opacity-5 -z-10" />
      
      {/* Main content with light background for readability */}
        ...
        <div className="container max-w-4xl mx-auto px-4">
          <div className="mb-12">
            <motion.h1 
              ...
              className="text-4xl sm:text-5xl font-extrabold text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-cyan-500"
            >
              Privacy Policy
            </motion.h1>
            <motion.p 
              ...
              className="text-xl text-center text-gray-700 dark:text-gray-300 max-w-2xl mx-auto mt-4"
            >
