                ...
                error={(error) => {
                  ...
                  return (
                    <div className="p-8 text-center">
                      <p className="text-red-500 mb-4">Failed to load PDF. Please try compiling again.</p>
                      <p className="text-xs text-gray-500 mb-4">Error details: {error.message || "Unknown error"}</p>
                      {onCompilePdf && (
                        <Button 
                          onClick={handleGeneratePdf}
